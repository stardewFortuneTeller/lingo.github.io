...
var startingRoom = [['LEVEL 2', 25, 'white', 1], ['HI', 'HI', 'white', 1],['TYPE', 'TYPE', 'white', 1],['THIS', 'THIS', 'white', 1],['WRITE', 'WRITE', 'white', 1],['SAME', 'SAME', 'white', 1]];
...
var startingTwoom = [["LEVEL 1", 26, 'white', 1], ["I", "I", 'white', 1], ["REMEMBER", "REMEMBER", 'white', 1], ["YOU", "YOU", 'white', 1], ["REMEMBER", "REMEMBER", 'white', 1], ["HELLO AGAIN", "HI", mint, 1]];
var theFuzzy = [["KIWI", "FRUIT", lime, 2], ["HEXAGON \\\\ STAR", "SHAPE", lime, 2], ["SPEAR \\\\ PEPPER", "MINT", lime, 2], ["BLOOD \\\\ NAVEL", "ORANGE", lime, 2], ["SURPRISE \\\\ DISGUST", "EMOTION", lime, 2], ["LOCK", "KEY", 'black', 2], ["THEY", "WE", 'black', 2], ["FIRST", "KIWI", mint, 1], ["SCULPTURE \\\\ CINEMA", "ART", lime, 2], ["CHOCOLATE \\\\ BRUNETTE", "BROWN", lime, 2], ["MAUVE \\\\ LAVENDER", "PURPLE", lime, 2], ["WRENCH \\\\ SCREWDRIVER", "TOOL", lime, 2], ["THE FUNNY", "THE FUZZY", 'purple', 1]];
var theExemplary = [["COW", "MOO", magenta, 0], ["SEAL \\\\ DOG", "BARK", magenta, 0], ["BEE", "BUZZ", magenta, 0], ["KOREAN", "AANYEONG", magenta, 0], ["DUTCH \\\\ GERMAN", "HALLO", magenta, 0], ["ENGLISH", "HI", magenta, 0], ["FRENCH", "SALUT", magenta, 0], ["NORWEGIAN \\\\ FINNISH", "HEI", magenta, 0], ["SPANISH", "HOLA", magenta, 0], ["SNAKE", "HISS", magenta, 0], ["SHEEP \\\\ GOAT", "BLEAT", magenta, 0], ["TURKEY", "GOBBLE", magenta, 0], ["THE EXEMPLARY", "THE EXEMPLARY", 'white', 1]];
var theFresh = [["WHITE", "HI", mint, 1], ["BLACK", "LEVEL", mint, 1], ["RED", "SACRED", mint, 1], ["ORANGE", "NUMBERS", mint, 1], ["YELLOW", "RUBY", mint, 1], ["GREEN", "GRAY", mint, 1], ["BLUE", "IRIS", mint, 1], ["PURPLE", "SOUTH", mint, 1], ["BROWN", "CAT", mint, 1], ["LIME", "FRUIT", mint, 1], ["MAGENTA", "MOO", mint, 1], ["MINT", "HI", mint, 1], ["THE FRESH", "THE FRESH", 'white', 1]]
var theUnscrambled = [];
...
var l2puzzles = startingTwoom.concat(theFuzzy, theExemplary, theFresh);
